...
{
    double gearspeedrule1 = Lmapping.nodes[0].localVariables[0];
...
public designGraph gearspeedbegrule3(designGraph Lmapping, designGraph host, designGraph Rmapping, double[] parameters)
{
    ...
    double teeth2rule3 = Rmapping.nodes[4].localVariables[2];
    double radius2rule3 = Rmapping.nodes[4].localVariables[3];
    /*obtaining new gear properties from right*/
    
    Rmapping.nodes[4].localVariables[0] = -(teeth1rule3/teeth2rule3);
    Rmapping.nodes[4].localVariables[1] = -((gearspeedrule3 * radius1rule3)/radius2rule3);
